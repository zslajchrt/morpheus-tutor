...
//  def process(v1: String): Unit
//}
//
//@dimension
//trait StringListProcessor {
//  def process(v1: List[String]): Unit
//}
//
//@fragment
//trait MyStringProcessor extends StringProcessor {
//  override def process(s: String): Unit = {
//    println(s)
//  }
//
//  val extraResult: Future[String]
//}
//
//@fragment
//trait NameReducer extends StringListProcessor {
//
//  this: StringProcessor =>
//
//  override def process(a: List[String]): Unit = {
//    val reduce: String = a.foldLeft("")(_ + _)
//    process(reduce)
//  }
//
//}
//
//@dimension @wrapper
//trait MyFilter1 extends StringListProcessor {
//
//  abstract override def process(a: List[String]) {
//    super.process(a.filter(_.length >= 10))
//  }
//
//}
//
//@dimension @wrapper
//trait MyFilter2 extends StringListProcessor {
//
//  abstract override def process(a: List[String]) {
//    super.process(a.filter(_.length >= 1))
//  }
//
//}
//
//
//object CodeEvolution {
//
//
//  def main(args: Array[String]) {
//
//    val pipe = singleton[MyStringProcessor with NameReducer with /?[MyFilter1] with /?[MyFilter2]].~
//    var res = pipe.process(List("One", "Two", "Three"))
//
////    val list = List.empty[Int]
////    val a = 1
////    list.map(_ * 2).or(s => a match {
////      case 1 => s.filter(_ > 1)
////      case 2 => s.filter(_ < 1)
////      case _ => s
////    })
//
//
////    list.map(_ * 2).filter(_ > 1).reduce(_ + _)
////    list.map(_ * 2).max
////    list.map(_ * 2).filter(_ <= 1).min
////
////
//
//
